...
dataMeth_cpg_minus65 <- fitData(sim_cpg_minus65,"cpg")
dataMeth_cpg_minus65 <- fitData(sim_cpg_plus65,"cpg")
dataMeth_chg_minus65 <- fitData(sim_chg_minus65,"chg")
dataMeth_chg_minus65 <- fitData(sim_chg_plus65,"chg")
dataMeth_chh_plus65  <- fitData(sim_chh_minus65,"chh")
dataMeth_chh_minus65 <- fitData(sim_chh_plus65,"chh")



peakRAM(DMR_calling(dataMeth_cpg_minus65,"Minus65", "CpG"))
peakRAM(DMR_calling(dataMeth_cpg_plus65,"Minus65", "CpG"))
peakRAM(DMR_calling(dataMeth_chg_minus65,"Minus65", "CHG"))
peakRAM(DMR_calling(dataMeth_chg_plus65,"Minus65", "CHG"))
peakRAM(DMR_calling(dataMeth_chh_minus65,"Plus65", "CHH"))
peakRAM(DMR_calling(dataMeth_chh_plus65,"Minus65", "CHH")
