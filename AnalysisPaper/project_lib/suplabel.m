...
%   [ax,h]=suplabel(text,whichLabel,supAxes,varargin)
% 
...
if(~exist('supAxes','var') | isempty(supAxes))
     supAxes=[.08 .08 .84 .84];
end
if(~exist('whichLabel','var') | isempty(whichLabel))
     whichLabel='x';
end
...
elseif strcmp('x',whichLabel)
  ...
  xlabel(text,varargin{:});
elseif strcmp('y',whichLabel)
  set(get(ax,'YLabel'),'Visible','on')
  ylabel(text,varargin{:});
end
if (nargout < 2)
  return
end
if strcmp('t',whichLabel)
  h=get(ax,'Title',varargin{:});
  set(h,'VerticalAlignment','middle')
elseif strcmp('x',whichLabel)
  h=get(ax,'XLabel',varargin{:});
elseif strcmp('y',whichLabel)
  h=get(ax,'YLabel',varargin{:});
end
