...
%hText = xticklabel_rotate(XTick,rot,XTickLabel,varargin)     
% 
% Rotate XTickLabel
%
% Input:    
...
if(iscell(xTickLabels)) 
    for i=1:length(xTickLabels)     % Clemens
        hText(i) = text(XTick(i), y(i), xTickLabels{i},'fontsize',fs); % Clemens
    end  % Clemens
else
