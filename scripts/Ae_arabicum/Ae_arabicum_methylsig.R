...
peakRAM(DMRcaller("C20", "CHG"))
peakRAM(DMRcaller("T20", "CHG"))
peakRAM(DMRcaller("C20", "CHH"))
peakRAM(DMRcaller("T20", "CHH"))
peakRAM(DMRcaller("C20", "CpG"))
peakRAM(DMRcaller("C25", "CpG"))
